    ...
    <>
      ...
      <section className="py-16 bg-warm-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            className="font-serif text-2xl font-bold mb-10 text-center"
            data-tina-field={tinaField(p, "contactHeading")}
          >
            {p.contactHeading}
          </h2>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="flex-1">
              <h3
                ...
                data-tina-field={tinaField(p, "organizerName")}
              >
                {p.organizerName}
              </h3>
              {p.organizerRole && (
                <p
                  className="text-dark/50 text-sm mb-6"
                  data-tina-field={tinaField(p, "organizerRole")}
                >
                  {p.organizerRole}
                </p>
              )}
              ...
              <dl className="space-y-4 text-sm">
                {p.phone && (
                  <div className="flex items-center gap-3">
                    <dt className="text-dark/50 font-semibold text-xs uppercase tracking-widest w-20">
                      Telefon
                    </dt>
                    <dd>
                      <a
                        ...
                        data-tina-field={tinaField(p, "phone")}
                        onClick={() =>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <dd>
                    <a
                      href={`mailto:${p.email ?? ""}`}
                      className="text-forest hover:text-dark transition-colors"
                      data-tina-field={tinaField(p, "email")}
                      onClick={() =>
                        posthog.capture("contact_link_clicked", {
                          type: "email",
                        })
                ...
                <div className="flex items-center gap-3">
                  ...
                  <dd>
                    <a
                      href={
                        p.facebookHref ?? "https://www.facebook.com/Handi4Camp"
                      }
                      target="_blank"
